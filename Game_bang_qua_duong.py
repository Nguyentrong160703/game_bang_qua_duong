...
class TroChoi:
    ...
    def chay_vong_lap_game(self, he_so_toc_do):
        ...
        while not game_over:
            ...
            # Vẽ các hình ảnh
            # pygame.draw.rect(man_hinh_game, MAU_DEN, [350, 350, 100, 100])
            # pygame.draw.circle(man_hinh_game, MAU_DEN, (400, 300), 50)
            ...
            pygame.display.update()
            # Bấm giờ, để qua vòng lặp tiếp theo
            dong_ho.tick(self.toc_do_bam_gio)
            
        # Kiểm tra nếu chiến thắng thì reset game
        if chien_thang:
...
class NhanVatNguoiChoi(DoiTuongGame):
    ...
    def di_chuyen(self, chieu, chieu_cao_man_hinh):
        ...
        # Kiểm tra để nhân vật không đi khỏi màn hình
    ...
    def kiem_tra_va_cham(self, doi_tuong_khac):
        ...
        # Trả về va chạm nếu không thỏa tất cả các điều kiện trên
        return True
